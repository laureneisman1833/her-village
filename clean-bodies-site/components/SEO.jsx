...
export default function SEO({ title, description, ogTitle, ogDescription, ogImage }) {
  ...
  const metaDescription = description || 'Products I personally use and trust. Raw organic almonds, simple skincare, homemade almond milk recipe, and custom 7-day reset plans.'
